...
class WP_JSON_Posts {
  ...
  protected function prepare_meta( $post, $data, $is_raw = false ) {
    ...
    if ( is_protected_meta( $key ) && ! (strrpos($key, '_', -strlen($key)) !== FALSE )) {
  ...
  public function add_meta( $id, $data ) {
    ...
    if ( is_protected_meta( $data['key'] ) && ! (strrpos($data['key'], '_', -strlen($data['key'])) !== FALSE )) {
      return new WP_Error( 'json_meta_protected', sprintf( __( '%s is marked as a protected field.'), $data['key'] ), array( 'status' => 403 ) );
    }
  ...
  public function get_acf_key_field($meta_key) {
    ...
    $acf_fields = array(
      ...
      'gallery_images' => 'field_58d3a27c2a814',
      ...
      'advisor_firesafety' => 'field_581c96fcb827c',
      'advisor_instalation' => 'field_581c96ceb8279',
      'advisor_physics' => 'field_581c96f0b827b',
      'architects' => 'field_581c968cb8276',
      'building_cost_excluding_installation' => 'field_581c99ebb828f',
      'building_cost_including_installation' => 'field_581c99d0b828e',
      'city' => 'field_581c9ca5a899d',
      'city_engineer' => 'field_581c9758b8281',
      'client' => 'field_581c965bb8274',
      'completion' => 'field_581c99bbb828d',
      'construction_management' => 'field_581c990bb8282',
      'construction_start' => 'field_581c99acb828c',
      'contractor' => 'field_581c970bb827d',
      'contributers' => 'field_581c969db8277',
      'cooperating_architect' => 'field_581c9924b8283',
      'country' => 'field_5812fef6de2f0',
      'definite_design' => 'field_581c99a3b828b',
      'design_bureau' => 'field_581c966fb8275',
      'extra_fields' => 'field_581c9a084b3aa',
      'gross_capacity' => 'field_581c9971b8287',
      'gross_floor_area' => 'field_581c9947b8285',
      'interior_architect' => 'field_581c9719b827e',
      'landscape_architect' => 'field_581c9723b827f',
      'location' => 'field_5813084bf9552',
      'project_main_image' => 'field_5816f6a6cf644',
      'main_image_caption' => 'field_5836f550f3d8f',
      'net_capacity' => 'field_581c997eb8288',
      'net_floor_area' => 'field_581c995eb8286',
      'project_galleries' => 'field_582469a2f3807',
      'project_gallery_caption' => 'field_58650c5d0cbed',
      'project_images' => 'field_58650c250cbec',
      'project_image' => 'field_582469a2f3808',
      'project_pdf_files' => 'field_582475e0b7188',
      'project_pdf_file' => 'field_582475e0b7189',
      'preliminary_design' => 'field_581c9992b828a',
      'program' => 'field_581c9988b8289',
      'project_type' => 'field_581c9f0c4b146',
      'province' => 'field_581c9c90a899b',
      'published_by' => 'field_58130861f9553',
      'suppliers' => 'field_581c993ab8284',
      'title' => 'field_581c964ab8273',
      'typology' => 'field_5812fecfde2ef',
      'visual_artist' => 'field_581c9735b8280',
      'year' => 'field_5813071741367',
  ...
  protected function insert_post( $data ) {
    ...
    // SEO fields
        if ( ! empty( $data['seo_fields'] ) ) {
            $result = $this->handle_post_meta_action( $post_ID, $data['seo_fields'] );
